          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">
                MoneySpot is the most truworth company in the market. All our
                deal are confident and reliable. We ensure the quality and the
                followup with our clients.
              </p>
