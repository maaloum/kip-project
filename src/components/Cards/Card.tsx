  ...
  return (
        ...
        <a href="#">
            ...
            <div className="px-4 py-3 w-72">
                ...
                <div className="flex items-center">
                    ...
                    <p className="text-lg font-semibold text-black cursor-auto my-2 text-red ">Available amount : ${product.amount}</p>
                    <p className="text-lg font-semibold text-black cursor-auto my-2 text-red">Price : ${product.price}</p>
    ...
    /* <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            ...
            <div className="px-4 py-3 w-72">
                <span className="text-gray-400 mr-3 uppercase text-xs">Bank</span>
                <p className="text-lg font-bold text-black truncate block capitalize">Huntington Bank</p>
                <div className="flex items-center">
    ...
    <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            ...
            <div className="px-4 py-3 w-72">
                <span className="text-gray-400 mr-3 uppercase text-xs">Bank</span>
                <p className="text-lg font-bold text-black truncate block capitalize">Sunset Bank</p>
                <div className="flex items-center">
                    <p className="text-lg font-semibold text-black cursor-auto my-3">$149</p>
                    <del>
                        <p className="text-sm text-gray-600 cursor-auto ml-2">$199</p>
